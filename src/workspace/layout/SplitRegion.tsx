        ...
        >
            {node.children.map((child, index) => {
                ...
                const separatorDisabled =
                    index > 0 &&
                    (childCollapsed || isCollapsedPanel(node.children[index - 1], collapsed));
                    ...
                    index > 0 && (
                        <div
                            ...
                            onPointerDown={
                                separatorDisabled
                                    ? undefined
                                    : (event) => handlePointerDown(event, separatorIndex)
                            }
                            onPointerMove={
                                separatorDisabled
                                    ? undefined
                                    : (event) => handlePointerMove(event, separatorIndex)
                            }
                            onPointerUp={separatorDisabled ? undefined : handlePointerUp}
                            onKeyDown={
                                separatorDisabled
                                    ? undefined
                                    : (event) => handleKeyDown(event, separatorIndex)
                            }
                        />
                    ),
