    ...
    return (
        <div className={styles.explain}>
            <p className={styles.hint}>
                Read the code below, then explain what the important parts do, line range by line
                range.
            </p>
                            ...
                            <p className={styles.annotationHeader}>
                                ...
                                {!submitted ? (
                                    <button
                                        ...
                                        onClick={() =>
                                            write({
                                                annotations: submission.annotations.filter(
                                ...
                                onChange={(event) =>
                                    write({
                                        annotations: submission.annotations.map((a) =>
                                            a.id === annotation.id
                                                ? { ...a, explanation: event.target.value }
                                                : a,
                                        ),
                                    })
                                }
